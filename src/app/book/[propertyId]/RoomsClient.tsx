      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-4 py-6 flex flex-col gap-6 pb-20">
        ...
        {settings.telefone && (
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-xl py-3.5 font-semibold text-sm border border-[#25D366]/40 text-[#25D366] hover:bg-[#25D366]/5 transition-colors"
          >
