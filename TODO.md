...
- [~] **1.4 Taxa turística: 5 → 12 concelhos** — **Faro e Sintra acrescentados (2026-09-17)**, ambos com fonte primária: Faro por Diário da República (Regulamento n.º 1207/2024, 2.ª série n.º 205/2024), Sintra pelo site oficial cm-sintra.pt. De caminho, corrigida uma fronteira que só se manifestaria em ano bissexto: a época baixa de Faro ia de `11-01` a `02-28`, o que deixava 29 de fevereiro sem taxa em nenhuma das duas épocas. 33 testes (incl. a fronteira bissexta e a passagem 31/10→01/11). **Restam 5 concelhos**: só entra aqui o que tiver regulamento municipal datado e coerente, não blogues (ex.: Cascais tinha uma fonte a dar 1 € quando são 4 €) — a Amora/Seixal, onde fica a única conta em produção, não tem TMT (não consta da lista de ~49 concelhos que a cobram)
